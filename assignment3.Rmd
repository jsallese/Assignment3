...
[SQL Injection Attack](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-21-23-12-56.png)
...
[Directory Traversal and File inclusion](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-21-23-16-13.png)
...
[Cross Site Request Forgery](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-21-23-23-37.png)
...
[Command injection](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-21-23-28-39.png)
...
[MySQL Charset Switch and MS-SQL DoS 
Attack](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-21-23-30-20.png)
...
[Hosts with the Most Failed Requests](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-21-23-47-26.png)
...
[Bot Activity](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-21-23-53-41.png)
...
[Hosts with the Most Failed Requests per Day ](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-22-00-00-34.png)

[Hosts with the Most Failed Requests per Month](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-22-00-02-53.png)
...
[Ratio of Failed to Successful Requests as a Time 
Series](cloudera-quickstart-vm-5.10.0-0-vmware-2017-04-22-18-37-45.png)
...
failedRequests <- read.csv("failedRequestsByDay.csv")
...
```
  ...
  The above plot shows an furthur aggregation to the data of
